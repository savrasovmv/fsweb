        ...
        if (!isCreate) {
            ...
            cg.then((resolve) => {
                ...
                if (resolve.length > 0) {
                    ...
                    APIClient.v1.get(LINE_TABLE, { callgroup_id: id })
                        .then((resolve) => {
                    ...
                    <Box >
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td>Номер</td>
                                    <td><FormField name="number" errors={errors} register={register} /></td>
                                </tr>
                ...
                <>
                    ...
                    <ButtonGroup>
                        <Button
                            ...
                            startIcon={<AddIcon />}
                            component={ReactLink}
                            to={'/web_callgroup:'+id+'/web_callgroupLineCreate'}
                        >
                            Добавить
                        </Button>
                        ...
                        <TableBody>
                            ...
                            {callGroupLineList.map((row) => (
                                <TableRow key={row.id}>
                                    ...
                                    <TableCell>
                                        <IconButton component={ReactLink} to={'/web_callgroup_line:' + row.id}>
                                            <EditIcon />
                                        </IconButton>
                                    </TableCell>
                                    <TableCell>
                                        <IconButton onClick={()=>handleDeleteLine(row.id)}>
                                            <DeleteIcon />
                                        </IconButton>
                                    </TableCell>
                                </TableRow>
